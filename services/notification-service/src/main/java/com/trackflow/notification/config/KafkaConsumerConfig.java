package com.trackflow.notification.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, ShipmentEvent> consumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.trackflow.notification.event");
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, ShipmentEvent.class.getName());
